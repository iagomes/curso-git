...
export default class BudgetDetailRespostaDatatableColumnPicklist2 extends LightningElement {
   
    @api recordId;
    @api recordTypeId = '0120j00000091K6AAI';
    @api disconnectFromParent;
    @api fieldApiName = 'OpportunityLineItem.Status__c';
    @api controllerValue;
    ...
    get options(){
        let options = [];
        console.log('getPicklistWithControlledValues >> this.picklistValues:::', this.picklistValues, JSON.stringify(this.picklistValues), this.value_, JSON.stringify(this.value_));
